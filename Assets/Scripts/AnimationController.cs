...
public class AnimationController : MonoSingleton<AnimationController>
{
	...
	{
		using (Dictionary<CollectBlockType, InGameUICollectBlock>.KeyCollection.Enumerator enumerator = CPanelGameUI.Instance.varPortrait.dicCollectObjs.Keys.GetEnumerator())
		{
	...
	public void RegistAnimation(IdleAnimationType aniType, QueueType queuetype, int count = 1, float pauseTIme = 0f, int numOfAniObj = -1)
	{
